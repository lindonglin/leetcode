...
public class MyAtoi {
    ...
    @Test
    public void case4() {
        Assert.assertEquals(Integer.MAX_VALUE, myAtoi("419399999999999999999999999999999"));
    }

    @Test
    public void case5() {
        Assert.assertEquals(Integer.MIN_VALUE, myAtoi("-419399999999999999999999999999999"));
